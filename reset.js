...
const events = [
  ...
  new Event({_id: 'Raft Day', people_invited: 'Everyone', location: 'The River', organizer: 'OC', date: new DOMString("2019-09-05"), description:'A party at the river. Bring rafts and fun'}),
