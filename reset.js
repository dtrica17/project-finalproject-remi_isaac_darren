...
const comments = [
  ...
  new User({_id: 'Isaac Brinkman', event: 'Titus', comment: '$30? What a rip off!'}),
  new User({_id: 'Darren Ricalton', event: 'Spring Fest', comment: "Who's the artist this year? I recommend Remi LeBlanc."}),
];
